...
export default function RootLayout({
  ...
  <div className="flex items-center justify-between h-16">
    <div className="flex items-center gap-8">
      <a href="/" className="flex items-center space-x-3 focus:outline-none focus:ring-2 focus:ring-accent/50 rounded-lg py-2">
        <span className="text-2xl font-bold text-white leading-none">ADHD Task Panel</span>
      </a>
    ...
    <div className="flex items-center gap-4">
      <div className="hidden md:flex items-center gap-3">
        <button className="px-4 py-2 text-sm font-medium rounded-lg bg-primary/10 hover:bg-primary/20 transition-colors focus:outline-none focus:ring-2 focus:ring-accent/50 shadow-none">
          Notifications
        </button>
        <button className="px-4 py-2 text-sm font-medium rounded-lg bg-accent text-white hover:bg-accent/90 transition-colors focus:outline-none focus:ring-2 focus:ring-accent/50 shadow-none">
          New Task
        </button>
      </div>
  ...
  <div className="md:hidden mobile-menu-overlay">
    <div className="px-2 pt-2 pb-3 space-y-1">
      ...
      <button className="px-4 py-2 rounded-lg bg-primary/10 hover:bg-primary/20 transition-colors focus:outline-none focus:ring-2 focus:ring-accent/50 shadow-none block w-full text-left">
        Notifications
      </button>
      <button className="px-4 py-2 rounded-lg bg-accent text-white hover:bg-accent/90 transition-colors focus:outline-none focus:ring-2 focus:ring-accent/50 shadow-none block w-full text-left">
        New Task
      </button>
    </div>
  </div>
